    ...
    <div class="logo position-relative">
        <a href="/">
            ...
            <div
                class="img"
                style="
                    background-image: url(https://maristar.com.br/wp-content/uploads/2018/12/logo-completa.png);
        ...
        <li class="list-inline-item">
            ...
            >
                <div class="position-relative d-inline-flex">
                    ...
                    <span
                        class="position-absolute notification-dot rounded-xl"
                    ></span>
                </div>
            </a>
            <div
            ...
            >
                <div class="scroll">
                    <ul class="list-unstyled border-last-none">
                        <li
                            class="mb-3 pb-3 border-bottom border-separator-light d-flex"
                        >
                            <img
                            ...
                            <div class="align-self-center">
                                <a href="#"
                                    >Joisse Kaycee just sent a new comment!</a
                                >
                            </div>
                        </li>
                        <li
                        ...
                        >
                            ...
                            <div class="align-self-center">
                                <a href="#"
                                    >New order received! It is total $147,20.</a
                                >
                            </div>
                        </li>
                        <li
                        ...
                        >
                            ...
                            <div class="align-self-center">
                                <a href="#"
                                    >3 items just added to wish list by a
                                    user!</a
                                >
                            </div>
                        </li>
                        <li
                            class="pb-3 pb-3 border-bottom border-separator-light d-flex"
                        >
                            <img
                            ...
                            <div class="align-self-center">
                                <a href="#"
                                    >Kirby Peters just sent a new message!</a
                                >
                            </div>
                        </li>
                    </ul>
        ...
        <ul id="menu" class="menu" style="display: none">
            ...
            <li>
                ...
                <ul id="pages">
                    <li>
                        <a
                            href="#authentication"
                            data-href="/Pages/Authentication"
                        >
            ...
            <li class="mega">
                ...
                <ul id="interface">
                    <li>
                        <a
                            href="#interfaceComponents"
                            data-href="/Interface/Components"
                        >
                    ...
                    <li>
                        ...
                        <ul id="interfaceForms">
                            ...
                            <li>
                                <a
                                    href="#formControls"
                                    data-href="/Interface/Forms/Controls"
                                >
                                ...
                                <ul id="formControls">
                                    <li>
                                        <a
                                            href="/Interface/Forms/Controls/Autocomplete"
                                        >
                                            <span class="label"
                                                >Autocomplete</span
                                            >
                                    ...
                                    <li>
                                        <a
                                            href="/Interface/Forms/Controls/CheckboxRadio"
                                        >
                                            <span class="label"
                                                >Checkbox-Radio</span
                                            >
                                    ...
                                    <li>
                                        <a
                                            href="/Interface/Forms/Controls/DatePicker"
                                        >
                                            <span class="label"
                                                >Date Picker</span
                                            >
                                    ...
                                    <li>
                                        <a
                                            href="/Interface/Forms/Controls/Dropzone"
                                        >
                                    ...
                                    <li>
                                        <a
                                            href="/Interface/Forms/Controls/Editor"
                                        >
                                    ...
                                    <li>
                                        <a
                                            href="/Interface/Forms/Controls/InputSpinner"
                                        >
                                            <span class="label"
                                                >Input Spinner</span
                                            >
                                    ...
                                    <li>
                                        <a
                                            href="/Interface/Forms/Controls/Rating"
                                        >
                                    ...
                                    <li>
                                        <a
                                            href="/Interface/Forms/Controls/Select2"
                                        >
                                    ...
                                    <li>
                                        <a
                                            href="/Interface/Forms/Controls/Slider"
                                        >
                                    ...
                                    <li>
                                        <a
                                            href="/Interface/Forms/Controls/Tags"
                                        >
                                    ...
                                    <li>
                                        <a
                                            href="/Interface/Forms/Controls/TimePicker"
                                        >
                                            <span class="label"
                                                >Time Picker</span
                                            >
                    ...
                    <li>
                        <a
                            href="#interfacePlugins"
                            data-href="/Interface/Plugins"
                        >
                        ...
                        <ul id="interfacePlugins">
                            ...
                            <li>
                                <a
                                    href="#pluginsDatatables"
                                    data-href="/Interface/Plugins/Datatables"
                                >
                                ...
                                <ul id="pluginsDatatables">
                                    <li>
                                        <a
                                            href="/Interface/Plugins/Datatables/EditableRows"
                                        >
                                            <span class="label"
                                                >Editable Rows</span
                                            >
                                    ...
                                    <li>
                                        <a
                                            href="/Interface/Plugins/Datatables/EditableBoxed"
                                        >
                                            <span class="label"
                                                >Editable Boxed</span
                                            >
                                    ...
                                    <li>
                                        <a
                                            href="/Interface/Plugins/Datatables/RowsAjax"
                                        >
                                    ...
                                    <li>
                                        <a
                                            href="/Interface/Plugins/Datatables/RowsServerSide"
                                        >
                                            <span class="label"
                                                >Server Side</span
                                            >
                                    ...
                                    <li>
                                        <a
                                            href="/Interface/Plugins/Datatables/BoxedVariations"
                                        >
                                            <span class="label"
                                                >Boxed Variations</span
                                            >
                                        </a>
                                    </li>
                                </ul>
                    ...
                    <li>
                        <a
                            href="#interfaceContent"
                            data-href="/Interface/Content"
                        >
                        ...
                        <ul id="interfaceContent">
                            <li>
                                <a
                                    href="#icons"
                                    data-href="/Interface/Content/Icons"
                                >
                                ...
                                <ul id="icons">
                                    <li>
                                        <a
                                            href="/Interface/Content/Icons/AcornInterface"
                                        >
                                            <span class="label"
                                                >Acorn Interface</span
                                            >
                                        </a>
                                    </li>
                                    <li>
                                        <a
                                            href="/Interface/Content/Icons/AcornCommerce"
                                        >
                                            <span class="label"
                                                >Acorn Commerce</span
                                            >
                                    ...
                                    <li>
                                        <a
                                            href="/Interface/Content/Icons/AcornLearning"
                                        >
                                            <span class="label"
                                                >Acorn Learning</span
                                            >
                                    ...
                                    <li>
                                        <a
                                            href="/Interface/Content/Icons/AcornMedical"
                                        >
                                            <span class="label"
                                                >Acorn Medical</span
                                            >
                                    ...
                                    <li>
                                        <a
                                            href="/Interface/Content/Icons/BootstrapIcons"
                                        >
                                            <span class="label"
                                                >Bootstrap Icons</span
                                            >
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <li>
                                <a
                                    href="#menuVarieties"
                                    data-href="/Interface/Content/Menu"
                                >
                                ...
                                <ul id="menuVarieties">
                                    <li>
                                        <a
                                            href="/Interface/Content/Menu/HorizontalStandard"
                                        >
                                            <span class="label"
                                                >Horizontal</span
                                            >
                                    ...
                                    <li>
                                        <a
                                            href="/Interface/Content/Menu/VerticalStandard"
                                        >
                                    ...
                                    <li>
                                        <a
                                            href="/Interface/Content/Menu/VerticalSemiHidden"
                                        >
                                            <span class="label"
                                                >Vertical Hidden</span
                                            >
                                        </a>
                                    </li>
                                    <li>
                                        <a
                                            href="/Interface/Content/Menu/VerticalNoSemiHidden"
                                        >
                                            <span class="label"
                                                >Vertical No Hidden</span
                                            >
                                        </a>
                                    </li>
                                    <li>
                                        <a
                                            href="/Interface/Content/Menu/MobileOnly"
                                        >
                                            <span class="label"
                                                >Mobile Only</span
                                            >
                                    ...
                                    <li>
                                        <a
                                            href="/Interface/Content/Menu/Sidebar"
                                        >
